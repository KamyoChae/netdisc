    ...
    <div class="padding">
            ...
            <form runat="server" class="form-horizontal" id="form1" method="post">
                <div class="form-group">
                    <label class="col-sm-2 control-label padding_lr_0 text-right">登录账号</label>
                    <div class="col-sm-2">
                        <asp:Literal ID="ltlLoginName" runat="server"></asp:Literal>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label padding_lr_0 text-right">原密码</label>
                    <div class="col-sm-2">
                        <input type="password" runat="server" id="OldPwd" name="OldPwd" class="form-control" placeholder="请填写原密码" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label padding_lr_0 text-right">新密码</label>
                    <div class="col-sm-2">
                        <input type="password" runat="server" id="NewPwd" name="NewPwd" class="form-control" placeholder="请填写新密码" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label padding_lr_0 text-right">确认密码</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <asp:Button ID="btnSave" runat="server" Text="确定修改" class="submit  praimery" 
