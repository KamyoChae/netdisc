...
{
    public partial class NewsManage : ManagerBase
    {
        ...
        private void Get_Data()
        {
            ...
            if (!string.IsNullOrEmpty(txtKey.Text.Trim()))
                where += " and (Title like '%" + txtKey.Text.Trim() + "%')";
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                if (DB.ExecuteSql("delete from News where Id=" + e.CommandArgument.ToString()) >= 0)
                {
