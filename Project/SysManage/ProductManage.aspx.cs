...
{
    public partial class ProductManage : ManagerBase
    {
        ...
        private void Get_Data()
        {
            ...
            if (!string.IsNullOrEmpty(txtKey.Text.Trim()))
                where += " and (UserName like '%" + txtKey.Text.Trim() + "%' or FenLeiName like '%" + txtKey.Text.Trim() + "%' or ProductName like '%" + txtKey.Text.Trim() + "%')";
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                if (DB.ExecuteSql("delete from Product where Id=" + e.CommandArgument.ToString()) >= 0)
                {
